...
import { isCardInCompactViewState } from '@/object-record/record-board/states/isCardInCompactViewState';
import { isCompactViewEnabledState } from '@/object-record/record-board/states/isCompactViewEnabledState';
